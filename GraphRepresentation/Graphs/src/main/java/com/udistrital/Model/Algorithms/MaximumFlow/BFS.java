...
public class BFS<T, U extends Number & Comparable<U>> {
    ...
    public boolean bfs(IVertex<T, U> source, IVertex<T, U> sink, Map<IVertex<T, U>, Map<IVertex<T, U>, Double>> residual, Map<IVertex<T, U>, IVertex<T, U>> parent) {
